        ...
        <div class="container-fluid">
            <div class="row m-minus">
                <div class="col-12">
                    ...
                    @include('front.page.people.expert.chunk.account-card')
                    @include('front.page.people.expert.chunk.social-info')
                    @include('front.page.people.expert.chunk.activity-blog')
                    @if (!empty($user->otherStaff(5 , $user->id)))
                        @include('front.page.people.expert.chunk.other-staffs', ['other_staffs' => $user->otherStaff(5 , $user->id)])
                    @endif
                </div>
            </div>
        </div>
