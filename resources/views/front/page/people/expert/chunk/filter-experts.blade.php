<form action="{{route('front.page.people.experts.index')}}" method="get" class="li-form companies-form">
    ...
    <label class="li-form-label companies-form__sphere"><span class="li-form-label-name">Компания:</span>
        <input type="text" name="company_id" class="li-form-input" value="{{request()->company_id}}">
    </label>
