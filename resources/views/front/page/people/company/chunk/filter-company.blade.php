<form action="{{route('front.page.people.companies.index')}}" method="get" class="li-form companies-form">
    <label class="li-form-label companies-form__name"><span class="li-form-label-name">Название:</span>
