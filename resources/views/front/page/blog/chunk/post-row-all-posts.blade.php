<div class="blog-row">
    <div class="row">
        <div class="col-auto">
            <a href="{{route('front.page.people.user', ['id' => $post->user->id])}}" class="companies-list__img li-portrait">
                <img src="{{$post->user->socialProfile->image ?? '/img/no_picture.jpg'}}" alt="{{$post->user->name}}">
            </a>
        </div>
        <div class="col">
