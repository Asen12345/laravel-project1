...
@section('content')
    ...
    <div class="col-12">
        <div class="box  box-primary">
            ...
            <div class="box-body">
                <form class="form-horizontal" method="POST" action="{{route('admin.text.page.update', ['id' => $textPage->id])}}" enctype="multipart/form-data">

                    {{ csrf_field() }}
                    <div class="form-group row">
                        <label for="title" class="col-sm-3 col-form-label text-right">Заголовок</label>
                        <div class="col-sm-7">
                            <input id="title" name="title" type="text" class="form-control" value="{{$textPage->title}}" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="published" name="published" type="checkbox" {{$textPage->published == true ? 'checked' : ''}}>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="url_ru" name="url_ru" type="text" class="form-control" value="{{$textPage->url_ru}}" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input disabled="" type="text" class="form-control url_en" value="{{$textPage->url_en}}">
                            <input id="url_en" name="url_en" type="hidden" class="form-control url_en" value="{{$textPage->url_en}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <textarea id="text" name="text" class="form-control summernote" rows="4" cols="50">{{$textPage->text}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="meta_title" name="meta_title" type="text" class="form-control" value="{{$textPage->meta_title}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="meta_keywords" name="meta_keywords" type="text" class="form-control" value="{{$textPage->meta_keywords}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="meta_description" name="meta_description" type="text" class="form-control" value="{{$textPage->meta_description}}">
                        </div>
                    </div>
