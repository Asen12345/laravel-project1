...
@section('content')
    ...
    <div class="col-12">
            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    ...
                    @foreach($data as $row)
                        <tr>
                            <td nowrap width='3%'>
                                <form class='form-inline' action="{{route('admin.resources.company.type.destroy', [$row->id])}}" method="POST" id='formDelete{{$row['id']}}'>
                            ...
                            <td>
                                <a href="{{route('admin.resources.company.type.edit', ['id' => $row->id])}}">{{$row->name}}</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
        ...
        <div class="pull-left">
            <a class="btn btn-primary btn-flat" href="{{route('admin.resources.company.type.create')}}">Добавить</a>
        </div>
