<div class="box box-primary">
  <div class="box box-default collapsed-box">
	...
	<!-- /.box-header -->
	<div class="box-body">
		<form class="form-horizontal" method="GET" action="{{route('admin.newsletter.unsubscribed.sort')}}" enctype="multipart/form-data">
			...
			<div class="box-footer">
				<a href="{{route('admin.newsletter.unsubscribed.index')}}" class="btn btn-default">Сбросить фильтры</a>
			</div>
		</form>
	</div>
	<!-- /.box-body -->
