            ...
            <div class="box-body">
                <form class="form-horizontal" method="POST" action="{{route('admin.news.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="published" name="published" type="checkbox" {{old('published') == 'on' ? 'checked' : ''}}>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select class="filter form-control" id="news_category_id" name="news_category_id" required>
                                <option></option>
                                    ...
                                    @if($category->parent_id == 0)
                                        ...
                                        @foreach($categories as $subcategory)
                                            @if($subcategory->parent_id == $category->id)
                                                <option value="{{$subcategory->id}}" {{old('news_category_id') ==  $subcategory->id  ? 'selected' : ''}}>{{$subcategory->name}}</option>
                                            @endif
                                        @endforeach
                                    @endif
                                @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select class="filter form-control js-example-basic-multiple" id="news_scene_id" name="news_scene_id[]" multiple="multiple">
                                @foreach($scenes as $scene)
                                    <option value="{{$scene->id}}"
                                    @if (!empty(old('news_scene_id')))
                                    {{in_array($scene->id, old('news_scene_id')) ? 'selected' : ''}}
                                    @endif >{{$scene->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="source_name" name="source_name" type="text" class="form-control" value="{{old('source_name')}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="source_url" class="col-sm-3 col-form-label text-right">Ссылка на источник новости</label>
                        <div class="col-sm-7">
                            <input id="source_url" name="source_url" type="text" class="form-control" value="{{old('source_url')}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="author_user_name" name="author_user_name" type="text" class="form-control" value="{{old('author_user_name')}}">
                            <input id="author_user_id" name="author_user_id" type="hidden" class="form-control" value="{{old('author_user_id')}}">
                        </div>
                    </div>
                    ...
                    @if (!empty('author_text_val'))
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input id="author_text_val" name="author_text_val" type="text" class="form-control" value="{{old('author_text_val') ?? ''}}">
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="form-group row">
                        <label for="published_at" class="col-sm-3 col-form-label text-right">Дата публикации новости</label>
                        <div class="col-sm-2">
                            <input id="published_at" disabled name="published_at" type="text" class="form-control datep" value="{{ \Carbon\Carbon::now()->format('d-m-Y') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="vip" name="vip" type="checkbox" {{old('vip') == 'on' ? 'checked' : ''}}>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="author_show" name="author_show" type="checkbox" {{old('author_show') == 'on' ? 'checked' : ''}}>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="yandex" name="yandex" type="checkbox" {{old('yandex') == 'on' ? 'checked' : ''}}>
                        </div>
                    </div>
