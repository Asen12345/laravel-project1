...
@section('content')
    ...
    <div class="col-12">
        <div class="box  box-primary">
            ...
            <div class="box-body">
                <form class="form-horizontal" method="POST" action="{{route('admin.posts.update', ['id' => $post->id])}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="published" name="published" type="checkbox" {{$post->published == true ? 'checked' : ''}}>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="announce" class="col-sm-3 col-form-label text-right">Анонс</label>
                        <div class="col-sm-7">
                            <textarea id="announce" name="announce" class="form-control" rows="4" cols="50">{!! old('announce') ?? $post['announce'] !!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <select autocomplete="off" class="filter form-control js-example-basic-multiple" id="tags" name="tags[]" multiple="multiple">
                                @foreach($tags as $tag)
                    ...
                    <div class="form-group row h-mt-20">
                        ...
                        <div class="col-sm-7">
                            <textarea id="text" name="text" class="form-control summernote" rows="4" cols="50" required="">{!! old('text') ?? preg_replace("/\r\n|\r|\n/",'<br/>',$post->text) !!}</textarea>
                            <span id="error-text"></span>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="source_name" class="col-sm-3 col-form-label text-right">Заголовок блога</label>
                        <div class="col-sm-7">
                            <span>{{$post->blog->subject}}</span>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="source_name" class="col-sm-3 col-form-label text-right">Автор блога</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label for="source_name" class="col-sm-3 col-form-label text-right">Количество комментариев</label>
                        <div class="col-sm-7">
					...
					<div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input id="created_at" disabled name="created_at" type="text" value="{{\Carbon\Carbon::parse($post->created_at)->format('d-m-Y') ?? ''}}">
                        </div>
                    </div>
					...
					<div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input id="published_at" disabled name="published_at" type="text" value="{{\Carbon\Carbon::parse($post->updated_at)->format('d-m-Y') ?? ''}}">
                        </div>
                    </div>
					
                    <div class="form-group row">
                        <label for="published_at" class="col-sm-3 col-form-label text-right">Количество просмотров</label>
                        <div class="col-sm-2">
                            <p>{{$post->views_count}}</p>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="published_at" class="col-sm-3 col-form-label text-right">Рейтинг записи</label>
                        <div class="col-sm-2">
                            <p>{{$post->getRating()}}</p>
                        </div>
                    </div>
