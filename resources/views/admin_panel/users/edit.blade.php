...
@section('footer_js')
    ...
    <script>
        $(document).ready(function () {
            ...
            let permissionSelect = $('#permission');
            let company_en = $('input[name="company_en"]');
            /*Validation Form*/
            $('#form').validator();
			$('#about_me').summernote({
                imageTitle: {
            ...
            function checkCompanyIsUser(id){
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data === true){
                            //$('#companyIsUser').css('display', '');
                            company_en.prop('readonly', true);
                        } else {
                            //$('#companyIsUser').css('display', 'none');
                            company_en.prop('readonly', false);
                        }
                    },
                });
            }
            ...
            permissionSelect.on('change', function () {
                ...
                if (val === 'company') {
                    ...
                    $('input[name=company_id]').prop('required', false);
                }
                checkPermission(val);
            });
            ...
            checkPermission(permissionSelect.val());
            checkPrivate(privateCheckBox, permissionSelect.val());
        });
        ...
        function checkPrivate (elem, permission) {
            if ($(elem).is(':checked') && permission === 'expert') {
                $('.work_div').css('display', 'none');
                $('#company_rus').prop('required',false);
                $('#ui-id-2').prop('required',false);
                $('#company_post').prop('required',false);
                $('input[name="company_en"]').val('');
                $('input[name="company_rus"]').val('');
