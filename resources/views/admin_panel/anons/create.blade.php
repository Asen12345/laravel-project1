            ...
            <div class="box-body">
                <form class="form-horizontal" method="POST" action="{{route('admin.'. $content['page'] .'.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input id="date" name="date" type="text" class="form-control datep" value="{{old('date')}}" style="position: relative;">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="will_end" class="col-sm-3 col-form-label text-right">Дата удаления</label>
                        <div class="col-sm-2">
                            <input id="will_end" name="will_end" type="text" class="form-control datep" value="{{old('will_end')}}" style="position: relative;">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="place" name="place" type="text" class="form-control" value="{{old('place')}}" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="organizer" name="organizer" type="text" class="form-control" value="{{old('organizer')}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="reg_linc" name="reg_linc" type="text" class="form-control" value="{{old('reg_linc')}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="main" name="main" type="checkbox" {{old('main') == 'on' ? 'checked' : ''}}>
                        </div>
                    </div>
