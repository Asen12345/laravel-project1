	  ...
	  <div class="box box-default collapsed-box">
		...
		<div class="box-body">
			<form class="form-horizontal" method="GET" action="{{route('admin.'.$page.'.sort', ['id' => request()->id])}}"
				...
				<div class="form-group row">
					<label for="user" class="col-sm-3 col-form-label text-right">Пользователь</label>
					<div class="col-sm-9">
						<input id="user" name="user" type="text" class="filter form-control" value="{{$filter_data['user'] ?? ''}}">
					</div>
				</div>

				<div class="form-group row">
					<label for="published" class="col-sm-3 col-form-label text-right">Активность пользователя</label>
					<div class="col-sm-9">
