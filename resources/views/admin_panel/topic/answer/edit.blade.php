...
@section('content')
    ...
    <div class="col-12">
        <div class="box  box-primary">
            ...
            <div class="box-body">
                <form class="form-horizontal" method="POST" action="{{route('admin.'. $content['page'] .'.update', ['answer_id' => $answer->id])}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select autocomplete="off" class="filter form-control js-example-basic-single" id="topic" name="topic_id">
                                <option value="{{$answer->topic_id}}">{{$answer->topic->title}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select autocomplete="off" class="filter form-control js-example-basic-single" id="user" name="user_id">
                                <option value="{{$answer->user_id}}">{{$answer->user->name}}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input id="published" name="published" type="checkbox" {{$answer->published == true ? 'checked' : ''}}>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <textarea id="text" name="text" class="form-control summernote" rows="4" cols="50">{{$answer->text}}</textarea>
                        </div>
                    </div>
