    ...
    <div class="col-12">
        <div class="box  box-primary">
			<div class="pull-right" style="margin-bottom:10px;margin-top:10px;margin-right:10px;">
				<a class="btn btn-primary btn-flat" href="{{route('admin.shop.researches.category.create')}}">Добавить</a>
			</div>
            <div class="box-body table-responsive no-padding">
                @include('admin_panel.shop.partials.category_table', ['table' => $content['fields'], 'categories' => $categories, 'sort_by' => $sort_by, 'sort_order' => $sort_order])
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Выберите новую категорию для исследований</h5>
