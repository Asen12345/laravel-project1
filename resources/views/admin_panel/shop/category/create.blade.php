...
@section('content')
    ...
    <div class="col-12">
        <div class="box  box-primary">
            ...
            <div class="box-body">
                <form class="form-horizontal" method="POST" action="{{route('admin.shop.researches.category.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 form-check">
                            <input id="show" name="show" type="checkbox" class="form-form-check-input">
                        </div>
                    </div>
                    <div class="form-group row">
