...
class MetaTagsController extends Controller
{
    ...
    public function index () {
        ...
        $templates = MetaTags::where('meta_id', '!=', 'meta_researches_main')
            ->where('meta_id', '!=', 'meta_researches_author')
            ->orderBy('id', 'asc')->paginate(50);

        return view('admin_panel.resources.meta_tags.meta_tags', ['content' => $content, 'templates' => $templates]);
    }
    ...
    public function edit($id) {
        ...
        return view('admin_panel.resources.meta_tags.meta_tags_edit', [
            'content'  => $content,
            'template' => $template
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('admin.resources.metatags')
